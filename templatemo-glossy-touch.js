let currentPage = 'home';
        ...
        // Initialize footer position AND setup menu
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Helpers to open/close the sidebar
  function openMenu() {
    if (!navLinks) return;
  ...
  // Clicking a menu link closes the menu (optional but nice)
  if (navLinks) {
    navLinks.querySelectorAll('a').forEach((a) => {
      a.addEventListener('click', closeMenu);
        ...
        // AFTER
// Form submission handling
const contactForm = document.querySelector('form'); // First, try to find the form

if (contactForm) { // Only run the code below IF a form was found
